...
const Products = () => {
    ...
    const addTodo = async () => {
        ...
        try {
            const { data } = await axios.post("http://localhost:5000/saveProducts", { text })
            setTimeout(() => {
                console.log(data)
                setText("");
    ...
    const editTodo = async (_id) => {
        ...
        try {
            const { data } = await axios.patch("http://localhost:5000/updateProducts", {
                _id,
                text: editedText,
            })
    ...
    const deleteTodo = async (_id) => {
        ...
        try {
            const { data } = await axios.delete(`http://localhost:5000/deleteproduct/${_id}`)
                                    ...
                                    >
                                        {item._id === editClicked ? (
                                            ...
                                            <div
                                                ...
                                                onClick={() => history.push(`/singleProduct/${item._id}`)}
                                            >
                                                {item.text}
                                            </div>
                                        )}
